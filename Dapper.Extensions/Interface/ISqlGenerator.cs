...
namespace Dapper.Extensions
{
    public interface ISqlGenerator
    {
        ...
        SqlConvertResult Select(IClassMapper classMapper, string condition, IDictionary<string, object> parameters, bool hasNoLock = true);
        SqlConvertResult Select(IClassMapper classMapper, int firstResult, int maxResults, string condition, IDictionary<string, object> parameters);
